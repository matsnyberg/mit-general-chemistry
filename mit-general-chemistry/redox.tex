...
\begin{example}
  ...
  \SI{25}{\celsius} of a cell in which the concentration of \ce{Zn^2+}
  is \SI{0.10}{\molar} and the concentration of \ce{Cu^2+} is
  \SI{0.0010}{\molar}.
  ...
  \item Calculate \cellpotentialO\ from the standard reduction
    ...
    \begin{inlinetable}{lcc}
      ...
      \ce{Cu^2+(aq) + 2e^- -> Cu(s)} & \ce{Cu^2+/Cu(s)} & \num{0.340} \\
      \ce{Zn(s) -> 2e^- + Zn^2+(aq)} & \ce{Zn^2+/Zn(s)} & \num{-0.7628} \\
    \end{inlinetable}
...
Vitamin \ce{B12} (cobalamin) has a large negative reduction potential. How is it
reduced in the body?
...
(\ce{B9}) is thought to be important in preventing heart disease,
...
Vitamin \ce{B12} is reduced by a protein called flavodoxin. Vitamin
\ce{B12} has a standard reduction potential of
\SI{-0.526}{\volt}. Flavodoxin has a standard reduction of
\SI{-0.230}{\volt}. This makes \ce{B12} a better reducing agent and
this suggests that Vitamin \ce{B12} should reduce flavodoxin. It is
however the other way around.

To see whether the reduction of \ce{B12} by flavodoxin is
...
reduction potential for Vitamin \ce{B12}. $E^0_{\text{oxidation}} =
...
We can see from this example that the reduction of Vitamin \ce{B12} by
...
\ce{B12} has such a low potential, one of the lowest known potential
